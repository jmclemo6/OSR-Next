...
### **Sub-Culture: Rock Gnome**

***Artificer's Lore***. Whenever you make an Intelligence check related to magic items, alchemical objects, or technological devices, you can add double your proficiency bonus to the roll.
...
***Mixed Cultures***. Pick 1 cultural trait from the _Elf_ entry and 1 from the _Human_ entry.
